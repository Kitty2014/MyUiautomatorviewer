        ...
        DefaultHandler handler = new DefaultHandler(){
            ...
            public void startElement(String uri, String localName, String qName,
                ...
                if ("hierarchy".equals(qName)) {
                    ...
                    tmpNode.addAtrribute(ComStrings.Xpath,tmpNode.getXpath());
                    ...
                    if (mParentNode != null) {
                        ...
                        if(mWorkingNode.getParent()!=null){
                        	...
                        	try{
                        		...
                        		pXpath = ((UiNode)parent).getAttribute(ComStrings.FXpath).substring(1);
                        		fXpath = "/" + pXpath + ((UiNode)mWorkingNode).getXpath();
                        		xpath = "/" + ((UiNode)mWorkingNode).getXpath();
                        		

                        		String pXpath2 = ((UiNode)parent).getAttribute(ComStrings.Xpath2).substring(1);
...
//                        			System.out.println("重复:"+xpath);
                        			try{
                            			...
                            			beginIndex = ((UiNode)parent).getAttribute(ComStrings.FXpath).length();
...
//                        				e1.printStackTrace();
                        				isP = true;
                        				xpath = fXpath;
                                		((UiNode)mWorkingNode).addAtrribute(ComStrings.FXpath,fXpath);
                                		((UiNode)mWorkingNode).addAtrribute(ComStrings.Xpath,fXpath);
                                		((UiNode)mWorkingNode).addAtrribute(ComStrings.UiaSelector,uiaStr);
                        				break;
                        			}
                        		}
                        		if(!isP){
                            		((UiNode)mWorkingNode).addAtrribute(ComStrings.FXpath,fXpath);
                            		((UiNode)mWorkingNode).addAtrribute(ComStrings.Xpath,xpath);
                            		((UiNode)mWorkingNode).addAtrribute(ComStrings.UiaSelector,uiaStr);
                        		}
                        	}catch(Exception e){
//                        		e.printStackTrace();
                    		...
                    		((UiNode)mWorkingNode).addAtrribute(ComStrings.Xpath2,xpath2);
                        	if(xpath.equals(fXpath)){
                        		((UiNode)mWorkingNode).addAtrribute(ComStrings.IsOnly,"false");
                        		//===================================
                        		((UiNode)mWorkingNode).addAtrribute(ComStrings.UiaSelector,"");
                        		//===================================
                        	}else{
                        		((UiNode)mWorkingNode).addAtrribute(ComStrings.IsOnly,"true");
                        	}
                            isP = false;
