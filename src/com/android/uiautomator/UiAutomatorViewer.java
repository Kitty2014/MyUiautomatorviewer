...
import com.android.uiautomator.actions.About;
...
public class UiAutomatorViewer extends ApplicationWindow {
    ...
    private UiAutomatorView uMode1;
...
//        toolBarManager.add(new ScreenshotAction(this,true));
    ...
    protected void configureShell(Shell newShell) {
        ...
        //设置工具标题
        newShell.setText(ComStrings.ToolsName);
//        Warning();
    }
...
//        uMode1=model;
    ...
    public void Warning(){
    	Object[] options = { "确认" }; 
    	JOptionPane.showOptionDialog(null, "Click OK to continue", "提示", 
    	JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, 
    	null, options, options[0]); 
    }
    
    public void set_sdk_path(){
