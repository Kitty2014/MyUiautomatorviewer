...
//    	String toolsDir = "E:\\android\\android\\sdk\\tools";
    	
    	String  toolsDir = JOptionPane.showInputDialog(ComStrings.Android_sdk_path_pop);
        if (toolsDir == null) {
        	Warning();
            return null;
        }
    ...
    public static void Warning(){
    	new Thread(new Runnable() {//500的时候弹出提示框 但主程序继续运行 
    	     public void run() { 
    	      JOptionPane.showMessageDialog(null, "Android SDK路径为空，将无法正常采集控件元素"); 
    	     } 
    	    }).start(); 
    }
}
